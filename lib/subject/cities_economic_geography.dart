        ...
        children: [
          Flexible(
            child: Column(
              ...
              children: [
                Text(t.findCityOnMap, style: const TextStyle(fontSize: 14)),
                Text(
                  _currentCity.name,
          ...
          Text('Счёт: $_score', style: const TextStyle(fontSize: 18)),
        ],
      ),
    );
  }
            ...
            child: Container(
              decoration: BoxDecoration(
                color: () {
                  ...
                  return Colors.pinkAccent; // обычные кнопки — сплошной цвет
                }(),
  ...
  Future<void> _showFinishDialog() async {
    ...
    await showDialog<void>(
      ...
      builder: (ctx) => AlertDialog(
        title: Text(t.done),
        content: Text(t.yourResult(_score, _cities.length)),
        actions: [
          TextButton(
            onPressed: () {
